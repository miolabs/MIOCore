...
final class MCJsonTests: XCTestCase {
    ...
    func testSerializableJSONConvertsUUID() {
        ...
        XCTAssertEqual( MIOCoreSerializableJSON( uuid ) as? String,
                        "6BA7B810-9DAD-11D1-80B4-00C04FD430C8" )
    }

    func testSerializableJSONConvertsDate() {
        let converted = MIOCoreSerializableJSON( Date( timeIntervalSince1970: 0 ) )
    ...
    func testSerializableJSONWalksNestedContainers() {
        ...
        let out = MIOCoreSerializableJSON( input ) as? [String: Any]
    ...
    func testSerializableJSONPassesScalarsThrough() {
        XCTAssertEqual( MIOCoreSerializableJSON( 42 ) as? Int, 42 )
        XCTAssertEqual( MIOCoreSerializableJSON( "hi" ) as? String, "hi" )
    }
    ...
    func testJsonStringifyProducesText() throws {
        let text = try MIOCoreJsonStringify( withJSONObject: ["k": "v"] )
